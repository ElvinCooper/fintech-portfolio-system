...
async def transferir_saldo(request: TransferenciaRequest, session: AsyncSession = Depends(get_async_session)):
    """
...
async def get_resumen_consolidado(session: AsyncSession = Depends(get_async_session)):
    """
